...
byte MP1090S::GetBand(void) {
      switch (MP1090S_REGS[MP1090S_SYSCONFIG2] & BAND_MASK) {  
            case MHz87_5_108: return MHz87_5_108;
            case MHz76_108:   return MHz76_108;
            case MHz76_90:    return MHz76_90;
            default: return 0;
      }
}
//------------------------------------------------------------------------------
...
byte MP1090S::GetSpace(void) {
      switch (MP1090S_REGS[MP1090S_SYSCONFIG2] & SPACE_MASK) {  
            case kHz200: return 200;
            case kHz100: return 100;
            case kHz50:  return 50;
            default: return 0;
      }
}
//------------------------------------------------------------------------------
...
long MP1090S::GetStation(void) {
      ...
      if (Band == MHz87_5_108) return (StationSpace * StationCode + 87500);
      else return (StationSpace * StationCode + 76000);
}
