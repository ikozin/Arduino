...
const static TDevicePin pin_map_1533_la4_la10_la24[] =
{
...
const static TDeviceVal values_1533_la4_la10_la24[] =
{
...
const __FlashStringHelper * K1533LA4LA10LA24::menu(void) {
  return F("ЛA4 ЛA10 ЛA24 (3 элемента 3И-HE)");
}

void K1533LA4LA10LA24::info(void) {
  Serial.println(F("KP1533ЛA4"));
  Serial.println(F("KP1533ЛA10  - открытый коллектор"));
  Serial.println(F("KP1533ЛA24  - повышеннаая нагрузка"));
  Serial.println(F("3 элемента 3И-HE   "));
