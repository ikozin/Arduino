...
const __FlashStringHelper * K1533LN1LN2LN3LN5LN8TL2::menu(void) {
  return F("ЛH1 ЛH2 ЛH3 ЛH5 ЛH8 ТЛ2 (6 элементов HE)");
}

const char K1533LN1LN2LN3LN5LN8TL2_Description[] PROGMEM = 
"KP1533ЛH1\r\n"
...
void K1533LN1LN2LN3LN5LN8TL2::info(void) {
  Serial.println((__FlashStringHelper *)K1533LN1LN2LN3LN5LN8TL2_Description);
}
