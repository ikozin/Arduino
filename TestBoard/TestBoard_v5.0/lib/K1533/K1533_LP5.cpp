...
const __FlashStringHelper * K1533LP5::menu(void) {
  return F("ЛП5 (4 элемента 2ИЛИ по модулю 2)");
}

const char K1533LP5_Description[] PROGMEM = 
"KP1533ЛП5\r\n"
...
void K1533LP5::info(void) {
  Serial.println((__FlashStringHelper *)K1533LP5_Description);
}